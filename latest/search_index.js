...

{
    ...
    "title": "Table - X",
    "category": "section",
    "text": "A table represents a matrix of data where each column is labeled. It can simply point to an external data file or store the data inline in the .tex file.Examples:julia> t = Table(\"data.dat\", \"x\" => \"Dof\");\n\njulia> print_tex(t)\n    table [x={Dof}]\n    {data.dat}Inline data is constructed using a keyword constructor:julia> t = Table(\"x\" => \"Dof\", \"y\" => \"Err\"; Dof = rand(3), Err = rand(3));\n\njulia> print_tex(t)\n    table [x={Dof}, y={Err}]\n    {Dof    Err\n    0.6073590230719768    0.36281513247882136\n    0.7285438246638971    0.11629575623266741\n    0.29590973933842424    0.9782972101143201\n    }If you load the DataFrames package, you can also create tables from data frames, see the TODO"
},
...

{
    ...
    "title": "PolarAxis",
    "category": "section",
    "text": "A PolarAxis plot data on a polar grid.Example:julia> PolarAxis( Plot( Coordinates([0, 90, 180, 270], [1, 1, 1, 1])))"
},
